...
class YolactNode(Node):
    ...
    def initParams_(self):
        self.yolact_path_ = '/home/sumukh/RBE502_Robot_Control/drone_ws/src/yolact'
        self.model_path_ = '/home/sumukh/RBE502_Robot_Control/drone_ws/src/yolact/weights/yolact_base_54_800000.pth'
        self.image_topic_ = '/simple_drone/front/image_raw'
        ...
        self.display_fps_ = True
        self.score_threshold_ = 0.15
