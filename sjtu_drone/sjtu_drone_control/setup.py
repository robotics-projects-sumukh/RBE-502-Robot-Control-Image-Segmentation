...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'pcl_correction = sjtu_drone_control.pcl_correction:main',
            'get_depth = sjtu_drone_control.get_depth:main',
            'webcam_publisher = sjtu_drone_control.webcam_publisher:main',
            'yolact = sjtu_drone_control.yolact:main',
        ],
    },
)
